...
# Notas (0.0)
- No tiene Errores Ni Warnings (0.5)      = 0.0 => 3 wqarnings y 7 Errores
- No tiene Codigo Innecesario  (0.5)      = 0.0
- Funciona y Cumple con el Objetivo (1.5) = 0.0
- El codigo Es Entendible (1.0)           = 0.5 => eXISTE lOGICA NO IMPLEMENTADA
- Cumple con el Codigo Limpio (1.5)       = 1.1
