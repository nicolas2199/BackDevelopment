...
# Notas (0.0)
- No tiene Errores Ni Warnings (0.5)      = 0.0 => Tienes 1 Warining
- No tiene Codigo Innecesario  (0.5)      = 0.0 => las cadens por defecto son arreglos
- Funciona y Cumple con el Objetivo (1.5) = 1.5
- El codigo Es Entendible (1.0)           = 0.5 => Seraia mejor seprar la Logica de Validaion final
