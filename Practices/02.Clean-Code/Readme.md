...
- Funciona y Cumple con el Objetivo (1.5) = 1.0 => Parcialmente
- El codigo Es Entendible (1.0)           = 0.5 => Falta Sacar Logica condicional y Funciones de valdacion
- Cumple con el Codigo Limpio (1.5)       = 0.9
  ...
  - No tiene contexto adicional o superfluo?                          = X
